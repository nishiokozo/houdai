...
#if 1
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/Foo/Private/MyShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/Foo/Private/MyShader.usf"), TEXT("MainPS"), SF_Pixel)
#else
FString ShaderDirectory = FPaths::Combine(FPaths::ProjectDir(), TEXT("Shader"));
//FString filepath = TEXT("/Project/Foo/Private/MyShader.usf");
FString filepath = ShaderDirectory + TEXT("/Foo/Private/MyShader.usf");
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, *filepath, TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, *filepath, TEXT("MainPS"), SF_Pixel)
#endif
